...
from model.datasets import obatin_train_test_tasks
from model.utils import init_trial_path
...
def get_parser(root_dir='.'):
    ...
    parser.add_argument('--pretrained_weight_path', type=str,
                        default=os.path.join(root_dir, 'model/model_file/supervised_contextpred.pth'),
    ...
    parser.add_argument("--result_path", type=str, default=os.path.join(root_dir, 'result'), help="result path")
