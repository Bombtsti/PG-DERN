...
def get_parser(root_dir='.'):
    ...
    # other
    parser.add_argument('--seed', type=int, default=10, help="Seed for splitting the dataset.")
    parser.add_argument('--gpu_id', type=int, default=0, help="Choose the number of GPU.")
    parser.add_argument("--result_path", type=str, default=os.path.join(root_dir,'results'), help="results path")
