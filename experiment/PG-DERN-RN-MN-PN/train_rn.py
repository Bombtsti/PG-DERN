...
class ProtoNetwork(nn.Module):
    ...
    def forward(self,x):
        ...
        z = self.encoder(x)
        z = z.view(z.size(0), -1)
        z_proto = z[:2 * 10].view(2, 10, -1).mean(1)
        zq = z[2 * 10:]
...
def main():
    sys.stdout = Logger('tox21-pn-10shot.txt')
    args = get_args('.')
    ...
    # if os.path.exists(str("./models/siderpn/feature_encoder_" + str(9) +"way_" + str(10) +"shot.pkl")):
    #     feature_encoder.load_state_dict(torch.load(str("./models/siderpn/feature_encoder_" + str(9) +"way_" + str(10) +"shot.pkl")))
    #     print("load feature encoder success")
    # if os.path.exists(str("./models/siderpn/relation_network_"+ str(9) +"way_" + str(0) +"shot.pkl")):
    #     relation_network.load_state_dict(torch.load(str("./models/proto_network_"+ str(10) +"way_" + str(0) +"shot.pkl")))
    #     print("load relation network success")
    # if os.path.exists(str("./models/message_gcn_"+ str(9) +"way_" + str(0) +"shot.pkl")):
    #     message_gcn.load_state_dict(torch.load(str("./models/message_gcn_"+ str(10) +"way_" + str(0) +"shot.pkl")))
    ...
    for episode in range(EPISODE):
        ...
        if episode%100 == 0:
            ...
            if avg_scores > last_scores:
                # save networks
                torch.save(feature_encoder.state_dict(),str("./models/pn10/feature_encoder_" + str(2) +"way_" + str(10) +"shot.pkl"))
                torch.save(relation_network.state_dict(),str("./models/pn10/proto_network_"+ str(2) +"way_" + str(10) +"shot.pkl"))
                torch.save(message_gcn.state_dict(),str("./models/pn10/message_gcn_" + str(2) + "way_" + str(10) + "shot.pkl"))
                print("save networks for episode:",episode)
                print(ts)
                with open('tspn.json', 'w') as json_file:
