...
from task_generator import obatin_train_test_tasks
...
def get_parser(root_dir='.'):
    ...
    ## loss term
    ### adjacency reg
    parser.add_argument('--reg_adj', type=float, default=10, help='reg adj loss weight')  # 1
    parser.add_argument('--dis_loss', type=int, default=0.01)
    # other
