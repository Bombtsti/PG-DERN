...
def meta_sgd_update(model, lrs=None, grads=None,adaptable_weights=None):
    """
...
class MetaSGD(BaseLearner):
    ...
    **Example**
    ...
    def __init__(self, model, lr=1.0, first_order=False, lrs=None, adaptable_weights=None):
        ...
        self.module = model
        if lrs is None:
            lrs = [th.ones_like(p) * lr for p in adaptable_weights]
    ...
    def clone(self,adaptable_weights):
        """
        **Descritpion**
        ...
        return MetaSGD(clone_module(self.module),
                       ...
                       adaptable_weights=adaptable_weights)

    def adapt(self, loss, adaptable_weights=None,first_order=None):
        """
        **Descritpion**
        ...
        self.module = meta_sgd_update(self.module, self.lrs, gradients,adaptable_weights)