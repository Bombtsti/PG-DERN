...
def get_parser(root_dir='.'):
    parser = argparse.ArgumentParser(
        description='Property-Aware Relation Networks for Few-Shot Molecular Property Prediction')
    # dataset
    ...
    parser.add_argument('-d', '--dataset', type=str, default='tox21',
                        help='data set name')  # ['tox21','sider','muv','toxcast']
    ...
    # few shot
    parser.add_argument("--n-shot-train", type=int, default=10,
                        help="train: number of shot for each class")  # choices=[1,10]
    parser.add_argument("--n-shot-test", type=int, default=10,
    ...
    parser.add_argument('--pretrained_weight_path', type=str,
                        default=os.path.join(root_dir, 'chem_lib/model_gin/supervised_contextpred.pth'),
                        help='pretrained path')

    ## context map
    parser.add_argument('--map_dim', type=int, default=300, help='map dimensions ')  # 128
    ...
    ## relation graph
    parser.add_argument("--rel-hidden-dim", type=int, default=300, help="hidden dim for relation net")  # 128
    ...
    ## loss term
    ### adjacency reg
    parser.add_argument('--reg_adj', type=float, default=0, help='reg adj loss weight')  # 1
    parser.add_argument('--dis_loss', type=float, default=0.01)
    ...
    parser.add_argument("--result_path", type=str, default=os.path.join(root_dir, 'results_metasgd'), help="result path")
    parser.add_argument("--eval_steps", type=int, default=50)
    parser.add_argument("--save-steps", type=int, default=2000,
                        help="Training: Number of iterations between checkpoints")
    parser.add_argument("--save-logs", type=int, default=0)
    parser.add_argument("--support_valid", type=int, default=0)
    parser.add_argument("--n_head", type=int, default=1)
    parser.add_argument("--n_property", type=int, default=3)
    return parser
